            ...
            vertexDescriptor:(MDLVertexDescriptor *)vertexDescriptor
{
    ...
    CGRect bounds;
    Glyph *glyphs = [self p_glyphsForAttributedString:attrStr imageBounds:&bounds];
...
+ (Glyph *)p_glyphsForAttributedString:(CFAttributedStringRef)attributedString imageBounds:(CGRect *_Nullable)imageBounds {
